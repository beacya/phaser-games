...
//预加载
function preload() {
    game.load.image('n-2', './svg/2.svg');
    game.load.image('n-4', './svg/4.svg');
    game.load.image('n-8', './svg/8.svg');
    game.load.image('n-16', './svg/16.svg');
    game.load.image('n-32', './svg/32.svg');
    game.load.image('n-64', './svg/64.svg');
    game.load.image('n-128', './svg/128.svg');
    game.load.image('n-256', './svg/256.svg');
    game.load.image('n-512', './svg/512.svg');
    game.load.image('n-1024', './svg/1024.svg');
    game.load.image('n-2048', './svg/2048.svg');
    game.load.image('n-4096', './svg/4096.svg');
    game.load.image('n-8192', './svg/8192.svg');
